...
return [
    'ui' => [
        ...
        'transition_modal' => [
            ...
            'no_conditions' => 'No conditions — the transition is always open.',
            'condition_field_placeholder' => 'Attribute (e.g. amount, status)',
    ...
    'exceptions' => [
        ...
        'condition_blocked' => 'Transition to ":to" is blocked.',
        'attribute_not_met' => 'Condition not met: :field :op :value',
    ],
